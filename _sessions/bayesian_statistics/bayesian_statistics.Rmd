...
<ul>
  ...
  <li class="m2"><span>The prior on Cohen's <i>d</i> is those cases a <a href="https://en.wikipedia.org/wiki/Cauchy_distribution">Cauchy distribution</a>.</span></li>  
</ul>
...
<ul>
  ...
  <li class="m4"><span>BF<sub>01</sub> = 1/BF<sub>01</sub>.</span></li> 
</ul>
